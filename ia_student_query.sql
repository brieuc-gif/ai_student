...
#les juniors semblent moins utilisés l'IA que les séniors 
...
#Il y a une plus grande disparité entre les sujets d'études. les STEM et Business utilisent beaucoup plus l'IA, et on peut émettre l'hypothèse d'une corrélation entre l'utilisation d'une IA et le temps d'étude, car plus on utilise moins on étudie (l'IA est-il un gain de temps?)
...
;
#Ceux qui maitrisent mieux l'IA semblent l'utiliser plus que les autres
...
# Ceux qui maitrisent l'IA ont l'air d'avoir des meilleurs notes, mais pour vérifier s'il y a vraiment corrélation il faut inclure le temps d'étude
...
#On a calculé le nombre de personne pour chaque groupe, maintenant il faut faire le ratio pour avoir vraiment une idée
...
#Il est difficile de comparer des catégories entre elles mais on remarque que pour les STEM qui sont ceux qui maitrise bien l'ia de manière générale ont les meilleurs moyennes
...
#Même en humanités on retrouve la même idée avec cet ordre : advanced, beginner, intermediate 
#On veut voir si le niveau est corrélé au nombre d'outils utilisés 
...
#Plus tu t'y connais en IA plus tu utilises différents outils
...
# Les personnes qui utilisent moins de 20h l'IA par semaine ont beaucoup moins de risques de Burnout
